...
class windows1:
    def __init__(self,master):
        ...
        self.button_reg = Button(self.Loginframe3,text = "Patient Regristration Window",font = ("arial",15,"bold"),
                                  command = self.Registration_window)
        self.button_reg.grid(row =0 , column = 0, padx = 10 , pady = 10)

        self.button_Hosp = Button(self.Loginframe3,text = "Patient Regristration Window",font = ("arial",15,"bold"),
                                  command = self.Hospital_window)
        self.button_Hosp.grid(row =0 , column = 1, padx = 10 , pady = 10)


        self.button_Dr_appt = Button(self.Loginframe3,text = "Patient Regristration Window",font = ("arial",15,"bold"),
                                  command = self.Dr_Appoint_window)
        self.button_Dr_appt.grid(row =1 , column = 0, padx = 10 , pady = 10)


        self.button_med_stock = Button(self.Loginframe3,text = "Patient Regristration Window",font = ("arial",15,"bold"),
    ...
    def login_system(self):
        ...
        if(user == str("admin") and (pswd == str("admin"))):
            ...
            tkinter.messagebox.askyesno("Phamracy Management System", "You have entered an invalid username or password")
    ...
    #First we will define all window
